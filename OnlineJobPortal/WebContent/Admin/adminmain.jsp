...
<div class="container">
    <div class="single">  
	   <table width="25%" border="1">
                ...
                "select * from login where authorization=?");        
                ...
                <tr>
                    ...
                    <td><a href="../RequestServlet?userid=<%= rs.getInt(1) %>&type=<%= rs.getString(4) %>&status=Accepted" >Accept</a></td>
                    <td><a href="../RequestServlet?userid=<%= rs.getInt(1) %>&type=<%= rs.getString(4) %>&status=Denied" >Deny</a></td>
                </tr>
                <%
                }
                %>
