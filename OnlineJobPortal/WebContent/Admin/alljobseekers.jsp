...
<div class="container">
    <div class="single">  
	   <table width="25%" border="1">
                <center><h1>Jobseekers:</h1></center>
                ...
                <tr>
                    ...
                    <td><a href="updatejobseeker.jsp?userid=<%= rs.getInt(1) %>&type=Jobseeker" >Edit</a></td>
                    <td><a href="../DeleteUserServlet?userid=<%= rs.getInt(1) %>&type=Jobseeker" >Delete</a></td>
                </tr>
                <%
                }
                %>
