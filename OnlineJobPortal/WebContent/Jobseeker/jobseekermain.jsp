...
<%
    try {
        if ((session.getAttribute("firstname")).toString() == null || (session.getAttribute("lastname")).toString() == null) {
...
<div class="banner_1">
	<div class="container">
		<div id="search_wrapper1">
		   ...
		   <h4>Jobseeker Home</h4>
		    <h1>Welcome <%=request.getSession().getAttribute("firstname") %> <%=request.getSession().getAttribute("lastname") %></h1>
			</div>
		</div>
   </div> 
</div>	
